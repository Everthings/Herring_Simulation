...
public static class DataClass{
    ...
    //not restored
    private static float treeSurvivalRate = 0.95f;
    private static float shrubSurvivalRate = 0.95f;
    private static float culvertSurvivalRate = 0.95f;
    private static float riverSurvivalRate = 0.95f;
